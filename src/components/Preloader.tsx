...
const Preloader = () => {
  ...
  return (
    <div
      className={`fixed inset-0 z-[100] flex items-center justify-center bg-gradient-to-br from-primary via-cbr-blue to-cbr-blue-dark transition-opacity duration-600 ${
    ...
    >
      <div className="flex flex-col items-center gap-8">
        ...
        <div className="relative">
          {/* Glow effect */}
          <div className="absolute inset-0 blur-3xl bg-accent/30 rounded-full scale-150 animate-pulse" />
        ...
        <div className="relative w-48 h-16">
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="animate-orbit">
              <div className="w-4 h-6 rounded-full bg-accent shadow-lg" />
            </div>
          </div>
          <div className="absolute inset-0 flex items-center justify-center" style={{ animationDelay: "0.5s" }}>
            <div className="animate-orbit-reverse">
              <div className="w-3 h-5 rounded-full bg-cbr-cyan shadow-lg" />
            </div>
          </div>
          <div className="absolute inset-0 flex items-center justify-center" style={{ animationDelay: "1s" }}>
            <div className="animate-orbit" style={{ animationDuration: "2s" }}>
              <div className="w-3 h-5 rounded-full bg-white/80 shadow-lg" />
            </div>
          </div>
        </div>
        ...
        <div className="text-center animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
          ...
          <p className="text-white/80 text-sm mt-2">Clinical Based Remedies</p>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="w-2.5 h-2.5 rounded-full bg-cbr-cyan animate-bounce" style={{ animationDelay: "300ms" }} />
        </div>
      </div>
    </div>
  );
